    ...
    <Dialog.Root>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed overflow-hidden left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 max-w-[640px] w-full h-[60vh] bg-slate-700 rounded-md flex flex-col outline-none">
          ...
          {/* o group usado abaixo faz com que tudo dentro do botao fique agrupado, e assim ao usar group-hover:underline no span, se eu passar o mouse no botao o underline ja aparece apenas na parte vermelha*/}
          <button
            type="button"
