    ...
    <Dialog.Root>
      <Dialog.Trigger className="rounded-md flex flex-col bg-slate-700 text-left p-5 gap-3 outline-none hover:ring-2 hover:ring-slate-600 focus-visible:ring-2 focus-visible:ring-lime-400">
        ...
        <p className="text-sm leading-6 text-slate-400">
          ...
          explicabo ipsam, ex reprehenderit ab maxime iste aliquid nemo odio.
          Illum eligendi laudantium laborum odit nihil eum mollitia
          reprehenderit, perferendis autem.
        </p>
      </Dialog.Trigger>
